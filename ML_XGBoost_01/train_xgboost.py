...
# Artefatos de pré-processamento: precisam ser reaplicados exatamente
# assim (sem "refit") em qualquer dataset novo (ex.: temporada 2026)
# para as features baterem com o que o modelo aprendeu.
