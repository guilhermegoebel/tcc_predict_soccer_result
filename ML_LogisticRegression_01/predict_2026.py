...
o modelo Regressão Logística já treinado (lr_match_result_model.pkl) na base football_matches_2026.

Pré-requisitos:
1. Ter rodado o script train_logistic_regression.py para gerar os artefatos (modelo, imputer, scaler e artifacts).

Uso:
    python predict_2026_lr.py
"""
...
ARTIFACTS_FILE = 'lr_preprocessing_artifacts.pkl'
...
# =============================================================
# 1. CARREGAR MODELO (LR) E ARTEFATOS
# =============================================================
with open(MODEL_FILE, 'rb') as f:
    model = pickle.load(f)

# Carregar o Imputer treinado (Mediana)
with open(IMPUTER_FILE, 'rb') as f:
    imputer = pickle.load(f)

# Carregar o Scaler treinado (StandardScaler)
...
# =============================================================
# 5. MONTAR X, PREENCHER NULOS E PADRONIZAR (LR)
# =============================================================
...
# 5.1 Imputação de NaNs com a mediana aprendida no treino
X_imp = imputer.transform(X)

# 5.2 Padronização na mesma escala (obrigatório para Regressão Logística)
...
print(f'\nCSV comparativo da Regressão Logística salvo em {OUTPUT_FILE}')
